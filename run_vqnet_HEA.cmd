...
:abla_B
python run_vqnet.py -M hea_amp -B 4   --name hea_amp_B=4
python run_vqnet.py -M hea_amp -B 8   --name hea_amp_B=8
...
REM Acc: 68.316832%
python run_vqnet.py -L log\hea_amp_B=4
python run_vqnet.py -L log\hea_amp_B=8
